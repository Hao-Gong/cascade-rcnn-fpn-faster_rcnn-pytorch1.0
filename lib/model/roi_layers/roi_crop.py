...
class ROICrop(Function):
    ...
    def forward(self, input1, input2):
        ...
        _C.BilinearSamplerBHWD_updateOutput_cuda(input1, input2, output)
        return output
    ...
    def backward(self, grad_output):
        ...
        _C.BilinearSamplerBHWD_updateGradInput_cuda(self.input1, self.input2, grad_input1, grad_input2, grad_output)
