...
# python json_fpn_sight32.py --net res101 --checksession 1 --checkepoch 4 --checkpoint 2968 --cuda --load_dir models --image_dir /media/gong/d16d2182-cf80-41fa-8c1a-ce10d644c955/datasets/xian_batch3/test
...
from model.utils.net_utils import save_net, load_net, vis_detections,vis_detections_better
import json
try:
    xrange          # Python 2
except NameError:
...
categoryList={'bg':0,'defect':1,'defect_detail':2,'fine':3, 'defect_vis_2_2':4, 'fine_vis_2_2':5,'scratch_vis_2_2':6,'bad_hole':7,'bad_hole_detail':8, 'fine_hole':9, 'defect_vis_5_1':10}
...
def parse_args():
  ...
  parser.add_argument('--image_dir', dest='image_dir',
                      ...
                      default="/media/gong/d16d2182-cf80-41fa-8c1a-ce10d644c955/datasets/xian_batch3/all_images")
# log and diaplay
...
# initilize the tensor holder here.
  ...
  json_file = open('sight32.json','w',encoding='utf-8')
...
#             print(pascal_classes[j],cls_dets.cpu())
            ...
            if vis:
              im2show = vis_detections_better(im2show, pascal_classes[j], cls_dets.cpu().numpy(),j, 0.5)
